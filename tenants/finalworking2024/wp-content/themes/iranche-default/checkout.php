<?php
/**
 * Checkout Template (WooCommerce-compatible)
 *
 * @package Themee
 */
...
<main class="pt-20 md:pt-40 lg:pt-[73px]">
    <div class="lg:px-20 lg:my-10 px-5">
        <div class="text-zinc-800 text-lg font-semibold bg-white shadow-large rounded-xl p-3 mb-6">
            تسویه حساب
            <div>
                <a class="text-sm text-zinc-500 hover:text-zinc-700 transition" href="<?php echo esc_url( wc_get_cart_url() ); ?>">سبد خرید</a>
                <span class="text-sm text-zinc-500">/</span>
                <a class="text-sm text-zinc-500 hover:text-zinc-700 transition" href="#">تسویه حساب</a>
            </div>
        </div>
        ...
        <?php if ( class_exists( 'WooCommerce' ) ) : ?>
            <?php if ( WC()->cart->is_empty() ) : ?>
                <div class="flex flex-col items-center justify-center p-8 bg-white shadow-large rounded-xl">
                    ...
                    <a href="<?php echo get_permalink( get_option( 'woocommerce_shop_page_id' ) ); ?>" class="bg-blue-500 hover:bg-blue-400 transition text-white px-6 py-3 rounded-lg">شروع خرید</a>
                </div>
            <?php else : ?>
                <?php
                    ...
                    <div class="md:flex gap-5">
                        <div class="md:w-8/12 px-2 sm:px-3 flex flex-col gap-y-7">
                            <div id="customer_details" class="space-y-6">
                                ...
                                <div class="bg-white shadow-large rounded-xl p-4">
                                    <h3 class="text-lg font-semibold text-gray-800 mb-4">جزئیات صورتحساب</h3>
                                    <?php do_action( 'woocommerce_checkout_billing' ); ?>
                                </div>

                                <div class="bg-white shadow-large rounded-xl p-4">
                                    <h3 class="text-lg font-semibold text-gray-800 mb-4">آدرس حمل و نقل</h3>
                        ...
                        <div class="md:w-4/12 mt-8 md:mt-0">
                            <div class="px-2 sm:px-6 py-3 bg-white rounded-xl shadow-large">
                                <h3 class="text-lg font-semibold text-gray-800 mb-4">سفارش شما</h3>
